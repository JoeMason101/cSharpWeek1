...
namespace dictionaries
{
    class Program
    {
        ...
        {
            Dictionary<string, string> codingLanguage = new Dictionary<string, string>();
              ...
              switch(result)
                {
                    case "a":
                        ...
                        if (int.TryParse(value1, out valid))
                        {
                            codingLanguage.Add(key1, value1);
                            Console.WriteLine("working");
                        } else
                        {
                            Console.WriteLine("MUST BE INT");
                        }
                        break;
                    case "r":
